...
import {
  ScalableSidebar,
  ScalableSidebarDivider,
  ScalableSidebarExpandButton,
  ScalableSidebarIntro,
  ScalableSidebarItem,
  ScalableSidebarSearchField,
  ScalableSidebarSpace,
} from '.';
...
export default {
  title: 'Layout/ScalableSideBar',
  component: ScalableSidebar,
  decorators: [
    (storyFn: () => JSX.Element) => (
...
export const SampleScalableSidebar = () => (
  <ScalableSidebar>
    <ScalableSidebarSearchField onSearch={handleSearch} to="/search" />
    <ScalableSidebarDivider />
    <ScalableSidebarItem
    ...
    <ScalableSidebarItem icon={HomeOutlinedIcon} to="#" text="Plugins" />
    <ScalableSidebarItem icon={AddCircleOutlineIcon} to="#" text="Create..." />
    <ScalableSidebarDivider />
    <ScalableSidebarIntro />
    <ScalableSidebarSpace />
    <ScalableSidebarExpandButton />
