...
- 2a6c393c0: The `create-plugin` command now prefers dependency versions ranges that are already in the lockfile.
- 12e074a6e: Fix duplication checks to stop looking for the old core packages, and to allow some explicitly
